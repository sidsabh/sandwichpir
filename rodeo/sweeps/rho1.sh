...
echo "RHO1_START $(date -u)"
for B in 64 128 256 512; do run_cfg 1 2048 524288 "$B"; done
for B in 64 128 256 512; do run_cfg 8 2048 4194304 "$B"; done
for B in 128 256 512; do run_cfg 8 65536  131072 "$B"; done
for B in 128 256 512; do run_cfg 8 131072 65536  "$B"; done
echo "RHO1_DONE $(date -u)"
